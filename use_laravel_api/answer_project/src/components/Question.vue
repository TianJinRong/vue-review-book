<template>
    <div class="questions container">
        ...
        <h1 class="page-header">{{question.question}}
            <router-link :to="'/question/' + question.id + '/edit'" class="btn btn-default">Edit</router-link>
...
export default {
    ...
    methods: {
        fetchQuestion(id) {
            let that = this;
            this.axios
                .get('http://questions.com/api/questions/' + id)
        ...
        deleteQuestion() {
            ...
            let that = this;
            this.axios
                .delete('http://questions.com/api/questions/'+this.question.id)
                .then(function (response) {
